 ...
 */
public class MainActivityOrgV2 extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        boolean readPermission = (ContextCompat.checkSelfPermission(MainActivityOrgV2.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);

        if (!readPermission) {
            ActivityCompat.requestPermissions(MainActivityOrgV2.this,
 ...
 */
    ...
    protected void showMessage(final String str, final char where) {
        ...
        switch (where) {
            ...
            case 't':
                Toast.makeText(MainActivityOrgV2.this, "\n" + str, Toast.LENGTH_SHORT)
                        .show();
                break;
            case 'l':
                NxpLogUtils.i(TAG, "\n" + str);
    ...
    private void showDisclaimer() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(MainActivityOrgV2.this);
        ...
        switch (requestCode) {
            case STORAGE_PERMISSION_WRITE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(MainActivityOrgV2.this, "Requested permission granted", Toast.LENGTH_LONG).show();

                } else {
                    Toast.makeText(MainActivityOrgV2.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
                break;
            }
        }
